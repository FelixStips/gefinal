...
SESSION_CONFIGS = [
    dict(
         ...
         market_timeout_seconds=10,                                                # Duration of market stage in seconds
         ...
         total_rounds=5,                                                           # Number of market rounds
...
PARTICIPANT_FIELDS = ['large_market', 'small_market', 'is_employer', 'playerID', 'string_role', 'migrant', 'realpay']
SESSION_FIELDS = []
