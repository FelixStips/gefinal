...
class ResultsWaitPage(WaitPage):
    ...
    def after_all_players_arrive(group: Group):
        ...
        #group.num_unmatched_workers = sum([p.participant.is_employer is False and p.is_employed is False for p in players]) if sum([p.is_employed is False for p in players]) > 0 else 0
